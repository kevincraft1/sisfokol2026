...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-3xl">
    <form action="<?= base_url('panel/galeri/update/' . $galeri['id']); ?>" method="POST" enctype="multipart/form-data">

        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Judul Foto</label>
                <input type="text" name="title" value="<?= $galeri['title']; ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none">
            </div>
            <div>
                ...
                <select name="type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    <option value="karya" <?= $galeri['type'] == 'karya' ? 'selected' : ''; ?>>Karya Siswa</option>
                    <option value="kegiatan" <?= $galeri['type'] == 'kegiatan' ? 'selected' : ''; ?>>Kegiatan</option>
                    <option value="fasilitas" <?= $galeri['type'] == 'fasilitas' ? 'selected' : ''; ?>>Fasilitas</option>
                </select>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="description" value="<?= $galeri['description']; ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none">
        </div>
        ...
        <div class="mb-6">
            ...
            <?php if ($galeri['image']): ?>
                <div class="mt-3">
                    ...
                    <img src="<?= base_url('uploads/galeri/' . $galeri['image']); ?>" class="w-32 rounded-lg border shadow-sm">
                </div>
            <?php endif; ?>
        </div>
